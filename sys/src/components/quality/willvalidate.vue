    ...
    <el-row class="client_table">
        <el-col :span="24">
          <el-table :border="true" :data="clientData" style="width: 100%">
            ...
            <el-table-column align="center" prop="servePeople" label="质检合格" min-width="100"></el-table-column>
            <el-table-column align="center" prop="time" label="产品规格" min-width="100"></el-table-column>
            <el-table-column align="center" prop="isMember" label="下单日期" min-width="80"></el-table-column>
            <el-table-column align="center" prop="isMember" label="加工交付日期" min-width="80"></el-table-column>
            <el-table-column align="center" prop="isMember" label="交货日期" min-width="80"></el-table-column>
            <el-table-column align="center" prop="isMember" label="下单人" min-width="60"></el-table-column>
            ...
            <el-table-column align="center" prop="operation" label="操作" min-width="130">
              <template slot-scope="scope">
                <el-button type="primary" @click="handleOrder(scope.row)" size="small">合格</el-button>
                <el-button type="primary" @click="handleOrder(scope.row)" size="small">驳回</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
