    ...
    <el-row class="client_table">
        <el-col :span="24">
          <el-table :border="true" :data="clientData" style="width: 100%">
            ...
            <el-table-column align="center" prop="name" label="  性别" min-width="60"></el-table-column>
            ...
            <el-table-column align="center" prop="servePeople" label="地址" min-width="100"></el-table-column>
            ...
            <el-table-column align="center" prop="operation" label="操作" min-width="90">
              <template slot-scope="scope">
                <el-button type="warning" @click="handleOrder(scope.row)" size="small">通知试穿</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
