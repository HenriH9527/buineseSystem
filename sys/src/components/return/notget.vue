    ...
    <el-row class="client_table">
        <el-col :span="24">
          <el-table :border="true" :data="clientData" style="width: 100%">
            ...
            <el-table-column align="center" prop="moduleState" label="提醒时间" min-width="80"></el-table-column>
            <el-table-column align="center" prop="moduleState" label="复查日期" min-width="80"></el-table-column>
            <el-table-column align="center" prop="operation" label="操作" min-width="90">
              <template slot-scope="scope">
                <el-button type="success" @click="handleOrder(scope.row)" size="small">人工提醒</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
