          ...
          <el-table :border="true" :data="clientData" style="width: 100%">
            ...
            <el-table-column align="center" prop="operation" label="操作" min-width="200">
              <template slot-scope="scope">
                ...
                <el-button type="primary" @click="handleOrder(scope.row)" size="small">打印订单</el-button>
                <el-button type="danger" @click="handleOrder(scope.row)" size="small">重新分配</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
